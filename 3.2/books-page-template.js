...
const body = `<body data-gr-c-s-loaded="true" class="">
%header%
%main%
%footer%
</body>`
const sectionHeader = `<section id="header" class="header-wrapper">
...
const sectionMain = `<section id="main" class="main-wrapper">
        <div class="container">
   ...
   const sectionFooter = `<section id="footer" class="footer-wrapper">
...
const templateBooksPage = booksHead
    .replace("%body%", body
        .replace("%header%", sectionHeader)
        .replace("%footer%", sectionFooter))

        
module.exports = {templateBooksPage, sectionHeader, sectionFooter, sectionMain, body}